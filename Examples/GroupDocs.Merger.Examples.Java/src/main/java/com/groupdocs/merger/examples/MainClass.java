...
public class MainClass {
	...
	public static void main(String[] args) throws Throwable {
		...
		//DocsManipulation.removeProtectionOfKnownFormatDoc("Output.docx");
		//DocsManipulation.removeProtectionOfUnknownFormatDoc("demo.docx");
		//DocsManipulation.setProtectionForKnownFormatDocs("demo.docx");
		//DocsManipulation.setProtectionForUnknownFormatDocs("demo.docx");
		//DocsManipulation.updateProtectionForKnownForamtDocs("Output.docx");
		//DocsManipulation.updateProtectionForUnknownForamtDocs("Output.docx");
		//DocsManipulation.updateProtectionForUnknownForamtDocs("Output.docx");
	}
}
